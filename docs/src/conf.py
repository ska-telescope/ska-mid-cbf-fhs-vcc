...
latex_documents = [
    (master_doc, 'SKA_MidCbf_FHS_VCC.tex', 'SKA Mid.CBF FHS-VCC Documentation',
     '{{author}}', 'manual'),
]
...
man_pages = [
    (master_doc, 'SKA_MidCbf_FHS_VCC', 'SKA Mid.CBF FHS-VCC Documentation',
     ['{{author}}'], 1)
]
...
texinfo_documents = [
    (master_doc, 'SKA_MidCbf_FHS_VCC', 'SKA Mid.CBF FHS-VCC Documentation',
     '{{author}}', 'SKA_MidCbf_FHS_VCC', 'FHS-VCC',
     'Miscellaneous'),
]
