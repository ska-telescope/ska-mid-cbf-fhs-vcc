...
class TestFrequencySliceSelection:
    ...
    def test_configure_command_invalid_config(self, device_under_test):
        ...
        # Define configuration input
        with open("tests/test_data/device_config/frequency_slice_selection_invalid.json", "r") as f:
            config_json = f.read()
    ...
    def test_status_command(self, device_under_test):
        ...
        with open("tests/test_data/device_status/frequency_slice_selection.json", "r") as f:
