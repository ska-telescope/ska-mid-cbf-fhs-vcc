...
class FhsLowLevelComponentManager(Generic[K, V], FhsComponentManagerBase):
    ...
    def is_recover_allowed(self: FhsLowLevelComponentManager) -> bool:
        ...
        return self.is_allowed(
            errorMsg, [ObsState.IDLE, ObsState.FAULT, ObsState.READY, ObsState.ABORTED]
        )
    ...
    def is_deconfigure_allowed(self: FhsLowLevelComponentManager) -> bool:
        ...
        return self.is_allowed(
            errorMsg, [ObsState.IDLE, ObsState.READY, ObsState.ABORTED, ObsState.FAULT]
        )
    ...
    def is_reset_allowed(self: FhsLowLevelComponentManager) -> bool:
        ...
        return self.is_allowed(
            errorMsg, [ObsState.FAULT, ObsState.READY, ObsState.IDLE, ObsState.ABORTED]
        )

    def is_allowed(
        self: FhsLowLevelComponentManager, error_msg: str, obsStates: list[ObsState]
    ) -> bool:
        result = True
    ...
    def test_cmd(
        self: FhsLowLevelComponentManager, task_callback: Optional[Callable] = None
